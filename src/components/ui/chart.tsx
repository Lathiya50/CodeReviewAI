...
/**
 * Hook to access chart config from context.
 * @returns ChartContextProps with config
 */
function useChart() {
...
/**
 * ChartContainer wraps recharts ResponsiveContainer with config context and CSS variable injection.
 * @param id - optional HTML id
 * @param className - optional className
 * @param children - recharts chart elements
 * @param config - ChartConfig for colors/labels
 * @returns Styled chart wrapper div with SVG CSS variables
 */
 ...
 * @param id - chart DOM id
 * @param config - ChartConfig with color/theme definitions
 */
...
/**
 * Tooltip component for recharts charts using shadcn styling.
 */
const ChartTooltip = RechartsPrimitive.Tooltip;

/**
 * Custom styled tooltip content for recharts charts.
 * @param active - whether tooltip is active
 * @param payload - data payload from recharts
 * @param className - optional className
 * @param indicator - style of indicator (dot, line, dashed)
 * @param hideLabel - whether to hide the label
 * @param hideIndicator - whether to hide the indicator
 * @param label - tooltip label
 * @param labelFormatter - custom label formatter
 * @param labelClassName - optional label className
 * @param formatter - custom value formatter
...
/**
 * Legend component for recharts charts.
 */
const ChartLegend = RechartsPrimitive.Legend;

/**
 * Custom styled legend content for recharts charts.
 * @param className - optional className
 * @param hideIcon - whether to hide icons
 * @param payload - legend items from recharts
 * @param verticalAlign - vertical alignment
 * @param nameKey - key for name lookup
 */
...
/**
 * Helper to extract config entry from recharts payload item.
 * @param config - ChartConfig
 * @param payload - recharts payload item
